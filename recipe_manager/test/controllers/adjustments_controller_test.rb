...
class AdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment" do
    assert_difference("Adjustment.count") do
      post adjustments_url, params: { adjustment: { condition: @adjustment.condition, fix: @adjustment.fix, recipe_id: @adjustment.recipe_id } }
    end
  ...
  test "should update adjustment" do
    patch adjustment_url(@adjustment), params: { adjustment: { condition: @adjustment.condition, fix: @adjustment.fix, recipe_id: @adjustment.recipe_id } }
